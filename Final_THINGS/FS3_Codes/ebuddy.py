...
'''
# Authentication Token : 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
...
class eBuddy:
    ...
    def construct_index(directory):
        ...
        os.environ["OPENAI_API_KEY"] = "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"
...
def ask_ebuddy(query):
    os.environ["OPENAI_API_KEY"] = "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"
    index = GPTSimpleVectorIndex.load_from_disk('/Users/orbiszeus/eBuddy/index.json')
